...
Print2file_OHE(D_iris1_train,'D_iris1_train.csv')%1- 100
Print2file_OHE(D_iris1_test,'D_iris1_test.csv')%1-100
%end for loop
Data_iris_2 = [];
for i=1:10
...
Print2file_OHE(D_iris2_train,'D_iris2_train0.csv')%1- 100
Print2file_OHE(D_iris2_test,'D_iris2_test0.csv')%1-100
%end for loop
...
Print2file_OHE(D_iris3_train,'D_iris3_train.csv')%1- 100
Print2file_OHE(D_iris3_test,'D_iris3_test.csv')%1-100
%end for loop
